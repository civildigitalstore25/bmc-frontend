...
export function ComingSoonHero({ siteName }: ComingSoonHeroProps) {
  return (
    <main className="relative min-h-dvh w-full overflow-x-hidden bg-primary">
      <BackgroundVideo />
      ...
      <div className="relative z-10 flex min-h-dvh w-full flex-col items-center justify-center px-4 py-10 sm:px-6 sm:py-16">
        <div className="flex w-full max-w-lg flex-col items-center gap-4 sm:max-w-2xl sm:gap-8">
          <div className="w-full space-y-2 px-1 text-center mt-55 md:mt-85 sm:space-y-4 sm:px-0">
